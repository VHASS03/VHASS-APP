...
// This allows tracking links like: https://domain.com/track/{sosId}
app.get('/track/:sosId', (req, res) => {
  res.redirect(307, `/api/sos/track/${req.params.sosId}`);
});
app.get('/track/:sosId/location', (req, res) => {
  res.redirect(307, `/api/sos/track/${req.params.sosId}/location`);
});
