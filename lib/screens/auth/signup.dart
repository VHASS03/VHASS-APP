...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void _initializeOTPListener() async {
    try {
      ...
      OTPService.onOTPReceived((otp, phone, expiresIn) {
        ...
        // If user is on OTP step and phone matches, auto-fill it
      ...
      print('✅ Signup OTP listener initialized');
    } catch (e) {
  ...
  Future<void> _handleNextStep() async {
    ...
    try {
      // Step 1: Register for OTP (real-time via Socket.IO) BEFORE signup
      print('📱 Step 1: Register for OTP before signup...');
      ...
      if (response.success) {
        ...
        // Send device SMS ONLY if backend didn't send
  ...
  Future<void> _resendOTPSilent() async {
    try {
      ...
      // Register for OTP (real-time via Socket.IO)
      await OTPService.registerForOTP(_phoneController.text);
          ...
          child: Column(
            ...
            children: [
              if (!_isOtpStep) ...[
                ...
                // Resend OTP button - now in the correct section
