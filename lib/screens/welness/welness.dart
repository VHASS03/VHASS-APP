...
class _WellnessScreenState extends State<WellnessScreen> {
  ...
  Map<String, List<String>> get _recommendations {
    switch (_cyclePhase) {
      case "Menstrual":
        return {
          "yoga": ["Child Pose", "Legs Up The Wall", "Supine Twist"],
          "remedies": [
            "Drink ginger tea",
            "Use heating pad",
      ...
      case "Follicular":
        return {
          "yoga": ["Sun Salutation", "Warrior II"],
          "remedies": ["Start strength training", "Eat protein rich meals"],
        };

      case "Ovulation":
        return {
          "yoga": ["Bridge Pose", "Camel Pose"],
          "remedies": ["High energy workouts", "Stay hydrated"],
        };

      default:
        return {
          "yoga": ["Forward Fold", "Cat Cow"],
          "remedies": ["Reduce caffeine", "Get good sleep"],
        };
    }
  }
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: TextField(
            ...
            maxLines: 3,
            decoration: const InputDecoration(hintText: "Symptoms or mood..."),
          ),
          actions: [
            TextButton(
  ...
  Widget _cycleDashboard() {
    ...
    final diff = today.difference(_lastPeriodDate).inDays % _cycleLength;

    final bool isOnPeriod = diff < _periodLength;

    final int periodDay = diff + 1;

    final daysLeft = _nextPeriodDate.difference(today).inDays;
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: selected ? const Color(0xFFE91E63) : theme.cardColor,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ...rec["remedies"]!.map(
            (e) => ListTile(leading: const Icon(Icons.spa), title: Text(e)),
          ),
        ],
      ),
    );
    ...
    return TableCalendar(
      ...
      calendarBuilders: CalendarBuilders(
        defaultBuilder: (context, date, _) {
          final diff = date.difference(_lastPeriodDate).inDays % _cycleLength;
    ...
    return Column(
      children: _notes.map((note) {
        return ListTile(
          ...
          subtitle: Text(DateFormat("MMM dd hh:mm").format(note["date"])),
        );
      }).toList(),
    );
  }
